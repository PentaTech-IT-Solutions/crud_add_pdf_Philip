...
if (isset($_POST["send"])) {
    ...
    try {
        ...
        <body style='background-color: #E2E2E2'>
            <table >
                <tr>
                    <td style='background-color: #A05284; color: #F2E6EE; text-transform: uppercase;'><strong>Subject:</strong> {$_POST["subject"]}</td>
                </tr>
                <tr>
                    <td>
                        ...
                        <ul>
                            <li><strong>Customer Name:</strong> {$_POST["name"]}</li>
                            <li><strong>Department:</strong> {$_POST["department"]}</li>
                            <li><strong>Email:</strong> {$_POST["email"]}</li>
                            <li><strong>Customer Message: </strong>{$_POST["message"]}</li>
                        </ul>
                    </td>
                </tr>
            </table>
